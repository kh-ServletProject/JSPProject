 ...
 <br>
    ...
    <div id="updateForm" style="display: none;">
      <form action="/updateUser" method="post">
          <div>
              아이디: <input type="text" name="memberId" value="${sessionScope.member.memberId}" style="margin-bottom: 10px;" readonly /><br>
              이름: <input type="text" name="memberName" value="${sessionScope.member.memberName}" style="margin-bottom: 10px;" /><br>
